...
class APIServices {
  static Future fetchUsers() async {
    return await http
        .get('http://10.89.32.31/HelpTheNeedyAPI/api/Registration');
  }
  ...
  static Future postUsers(Users users) async {
    ...
    var res = await http.post(
        'http://10.89.32.31/HelpTheNeedyAPI/api/Registration',
        headers: header,
        body: usersBody);
  ...
  static Future<http.Response> fetchNeedyDataCat(String id) async {
    return await http.get('http://10.89.32.31/HelpTheNeedyAPI/api/Data/' + id);
  }

  static Future<http.Response> fetchNeedyData() async {
    return await http.get('http://10.89.32.31/HelpTheNeedyAPI/api/Data');
  }
  ...
  static Future postNeedyData(NeedyData users) async {
    ...
    var myUsers = users.toJson();
    var usersBody = json.encode(myUsers);
    var res = await http.post('http://10.89.32.31/HelpTheNeedyAPI/api/Data',
  ...
  static Future<http.Response> fetchNGoData(String id) async {
    return await http
        .get('http://10.89.32.31/HelpTheNeedyAPI/api/NgoAction/' + id);
  }
  ...
  static Future postNGoData(Ngo users) async {
    ...
    var usersBody = json.encode(myUsers);
    var res = await http.post(
        'http://10.89.32.31/HelpTheNeedyAPI/api/NgoAction',
        headers: header,
        body: usersBody);
    print(res.statusCode);
    return res.statusCode;
