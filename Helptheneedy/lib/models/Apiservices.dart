...
class APIServices {
  static Future fetchUsers() async {
    return await http
        .get(Uri.parse('http://164.100.200.46/HelpTheNeedyAPI/api/Registration'));
  }
  ...
  static Future<http.Response> fetchNeedyDataCat(String id) async {
    return await http
        .get(Uri.parse('http://164.100.200.46/HelpTheNeedyAPI/api/Data/' + id));
  }

  static Future<http.Response> fetchNeedyData() async {
    return await http
        .get(Uri.parse('http://164.100.200.46/HelpTheNeedyAPI/api/Data'));
  }
  ...
  static Future postNeedyData(NeedyData users) async {
    ...
    var usersBody = json.encode(myUsers);
    var res = await http.post(
        Uri.parse('http://164.100.200.46/HelpTheNeedyAPI/api/Data'),
        headers: header,
        body: usersBody);
    print(res.body);
    return res.body;
  ...
  static Future<http.Response> fetchNGoData(String id) async {
    return await http.get(
        Uri.parse('http://164.100.200.46/HelpTheNeedyAPI/api/NgoAction/' + id));
  }
  ...
  static Future postNGoData(Ngo users) async {
    ...
    var usersBody = json.encode(myUsers);
    var res = await http.post(
        Uri.parse('http://164.100.200.46/HelpTheNeedyAPI/api/NgoAction'),
        headers: header,
        body: usersBody);
    print(res.statusCode);
    return res.statusCode;
  ...
  static Future postFeedback(Feedbackmod users) async {
    ...
    var usersBody = json.encode(myUsers);
    var res = await http.post(
        Uri.parse('http://164.100.200.46/HelpTheNeedyAPI/api/Feedback'),
        headers: header,
        body: usersBody);
    print(res.statusCode);
    return res.statusCode;
